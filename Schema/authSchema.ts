...
export const ProjectSchema = z.object({
    ...
    description : z.string().min(20 , "Description is too small").max(50),
...
export const ProfileSchema = z.object({
    ...
    description : z.string().min(10 , "Enter character more than 10").max(50),
    image : z.instanceof(File)
...
export const bioSchema = z.object({
    fullName : z.string().min(3 , "Full name is too short. Minimum 3 characters.").max(20 , "Full name is too long. Maximam 20 characters."),
    jobTitle : z.string().min(3 , "Job title is too short. Minimum 3 characters.").max(25 , "Job title is too long. Maximam 25 characters."),
...
export const socialMediaSchema  = z.object({
    Gmail : z.string().url().optional().or(z.literal("")),
...
export const aboutSchema = z.object({
    about : z.string().min(20 , "About is too short. Minimum 20 characters.").max(200 , "About is too long. Maximum 200 characters."),
    experience : z.string().min(20 , "Experience is too short. Minimum 20 characters.").max(200 , "Experience is too long. Maximum 200 characters."),
    goals : z.string().min(20 , "Goals is too short. Minimum 20 characters.").max(200 , "Goals is too long. Maximum 200 characters."),
})
